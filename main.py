...
# controllers.append(ModelController("weights/srikar_iter_6_3opp_od_seploop_suite5_0_1_bn_definition.json", goals[0], static_obs=scenario.obstacles.copy())) # Doorway livenet
...
# controllers.append(ModelController("weights/srikar_iter_6_3opp_od_seploop_suite5_0_1_bn_definition.json", goals[1], static_obs=scenario.obstacles.copy())) # Doorway livenet

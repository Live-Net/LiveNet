...
class GMPERunner(Runner):
    ...
    def render(self, get_metrics: bool = False):
        ...
        for episode in range(self.all_args.render_episodes):
            ...
            # print("node_obs shape: ", node_obs.shape)
            # print("adj shape: ", adj.shape)
            # print("agent_id shape: ", agent_id.shape)
            ...
            print(f"rnn_states {np.concatenate(rnn_states).shape}")
            print(f"masks {np.concatenate(masks).shape}")
